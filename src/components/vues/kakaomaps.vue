            ...
            <div class="col-md-12">
              ...
              >
                <div
                  id="accordion"
                  class="checkout"
                  v-for="(element, i) in selectlist"
                  :key="element.id"
                >
                  <div
                    class="panel"
                    style=" border-bottom: 1px solid lightslategrey; margin-bottom:0;"
                    draggable="true"
                  >
                    <div>
                      <span class="checkout-step-number">{{ ++i }}</span>
